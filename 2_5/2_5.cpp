...
//Т.к. в условии задачи сказано, что n больше 2, проверим правильность воодимого пользователем значения с помощью оператора if, 
//в случае несоответствия данному условию выводим сообщение пользователю об ошибке.
