...
//По условию задачи нам необходимо построить прямоугольный равнобедренный треугольник из звездочек со сторонами катетов, равными N, и прямым углом слева сверху. 
...
//Для дальнейшей работы нам понадобятся новая переменная z=n (поскольку прямой угол находится сверху слева, пробелы не нужны) для обозначения количества звездочек, из которых будет строиться треугольник. 
