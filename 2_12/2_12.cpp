...
//n - целочисленная переменная для обозначения длины последовательности, t - для обозначения элементов последовательности, вводимых пользователем, 
//max и min - для нахождения максимального и минимального элементов и sum - для суммы максимального и минимального.
